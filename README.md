# Developer Agreement collection

[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/digital-land/brownfield-land/blob/master/LICENSE)

A collection of Developer Agreements collected from Local Authorities.

The national dataset is in a format consistent with other Digital Land datasets as defined by the [Developer Agreement schema](https://digital-land.github.io/specification/schema/developer-agreement/).
...
The collection is [updated nightly](https://github.com/digital-land/developer-agreement-collection/actions) by the [GitHub Action](.github/workflows/run.yml).
